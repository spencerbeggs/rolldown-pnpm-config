...
* [Test file layout](test-layout.md) - Tests live in package/\_\_test\_\_/, never co-located in src/; classification is by filename suffix, and utils/fixtures are per-category and excluded from discovery.
