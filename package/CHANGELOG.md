...
[#195]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/195
...
[#191]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/191
...
[#188]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/188
...
| oxc-parser | dependency | updated | ^0.150.0 | ^0.151.0 |
...
[#185]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/185
...
[#178]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/178
...
- The runtime's `securityMin` divergence message is now field-agnostic — it reads "Lowers a managed security minimum from X to Y" instead of release-age-specific wording. Behavior is unchanged; only the phrasing. [#176][#176]

### Thanks

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#176]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/176
...
[#173]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/173
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| oxc-parser | dependency | updated | ^0.149.0 | ^0.150.0 |
...
[#162]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/162
...
[#157]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/157
...
[#155]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/155
...
| oxc-parser | dependency | updated | ^0.148.0 | ^0.149.0 |
...
[#142]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/142
...
[#139]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/139
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| oxc-parser | dependency | updated | ^0.147.0 | ^0.148.0 |
...
[#131]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/131
...
[#117]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/117
...
[#103]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/103
...
[#101]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/101
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/workspaces | dependency | updated | ^0.17.2 | ^0.18.0 | [#99][#99] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#99]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/99
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/workspaces | dependency | updated | ^0.17.0 | ^0.17.1 | [#93][#93] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#93]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/93
...
- Fix `normalizeCatalogs` so it no longer throws when the catalogs map
  ...
  empty enumeration for workspace-sourced entries. [#91][#91]

### Minor Changes

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#91]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/91
...
- | Dependency | Type | Action | From | To |  |
  ...
  | rolldown | peerDependency | updated | 1.2.4 | 1.2.5 | [#86][#86] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#86]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/86
...
- | Dependency | Type | Action | From | To |  |
  ...
  | effect | dependency | updated | 4.0.0-beta.107 | 4.0.0-rc.109 | Thanks [@spencerbeggs](https://github.com/spencerbeggs)! |
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/yaml | dependency | updated | ^0.7.0 | ^0.8.0 | [#71][#71] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#71]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/71
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/npm | dependency | updated | ^0.6.0 | ^0.8.1 |  |
  | @effected/semver | dependency | updated | ^0.2.1 | ^0.3.1 |  |
  | @effected/yaml | dependency | updated | ^0.6.0 | ^0.6.1 |  |
  | oxc-parser | dependency | updated | ^0.142.0 | ^0.143.0 | [#62][#62] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#62]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/62
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | oxc-parser | dependency | updated | ^0.141.0 | ^0.142.0 | [#58][#58] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#58]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/58
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @effected/yaml | dependency | updated | ^0.5.1 | ^0.6.0 | [#53][#53] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#53]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/53
...
- | Dependency | Type | Action | From | To |  |
  ...
  | effect | dependency | updated | 4.0.0-beta.99 | 4.0.0-beta.101 | [#51][#51] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#51]: https://github.com/spencerbeggs/rolldown-pnpm-config/pull/51
